...
| `cjkFontFamily` | string | 否 | 中文渲染首选字体；所有模板/主题默认使用本地 Excalidraw 提供的 `Ma Shan Zheng` |
| `cjkFontFallbacks` | string[] | 否 | 中文字体回退顺序；默认包含 `Long Cang`、`Liu Jian Mao Cao` 及本机字体，字体文件不随 skill 分发 |
